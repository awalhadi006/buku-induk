...
export function buildTemplateBuffer(): Uint8Array {
	const guide = XLSX.utils.aoa_to_sheet([
		...
		['2. Sheet "data wajib" WAJIB diisi (9 kolom). Sheet "data opsional" boleh kosong total, hanya isi NIS, atau penuh.'],
		['3. Jika "data opsional" diisi NIS-nya, sistem otomatis cocokkan dengan NIS di "data wajib" (tidak perlu urut sama).'],
		['4. Kolom NIS ada di KEDUA sheet sebagai kunci pencocokan — isinya harus sama bila keduanya diisi.'],
		['5. Kolom wajib (Nama, NIS, NISN, Jenis Kelamin, Tempat Lahir, Tanggal Lahir, Alamat, Nama Ayah, Nama Ibu) sebaiknya terisi semua; sisanya opsional.'],
		['6. Jenis kelamin: L atau P'],
		['7. RT/RW otomatis jadi 3 digit (contoh: 9 atau 09 tersimpan sebagai 009).'],
		['8. Tanggal lahir bebas formatnya: 10/11/2026, 10-11-2026, atau 10 November 2026 — otomatis dirapikan sistem.'],
		['9. Status santri: aktif, khusus, mutasi_keluar, lulus, wafat, drop_out'],
		['10. Status keluarga: yatim, yatim_piatu, dhuafa, umum'],
		['11. Kamar: nomor kamar (contoh: 3). Kelas: tingkat+rombel (contoh: 7A).'],
		[''],
