...
{#if data.kamar === undefined || data.santri === undefined || data.rekap === undefined}
	<div class="mt-8" role="status" aria-busy="true" aria-live="polite">
		<div class="grid grid-cols-3 gap-4 mb-6">
			<Skeleton variant="stat" ariaLabel="Memuat statistik kamar..." />
			<Skeleton variant="stat" ariaLabel="Memuat statistik kamar..." />
			<Skeleton variant="stat" ariaLabel="Memuat statistik kamar..." />
		</div>
		<Skeleton variant="table" rows={5} cols={4} ariaLabel="Memuat daftar santri kamar..." />
	</div>
{:else}
